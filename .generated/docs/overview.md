...
**[RiskIQ](vendors/MSRiskIQ/overview.md)** (17 integrations)

**[Shodan](vendors/Shodan/overview.md)** (6 integrations)
  Shodan is the search engine for internet-connected devices, providing reconnaissance data on expo...
...
**[Palo Alto AutoFocus](vendors/PaloAltoAutofocus/overview.md)** (3 integrations)
  AutoFocus is Palo Alto Networks' cloud-based threat intelligence platform, letting analysts searc...
...
**[MaxMind](vendors/MaxMind/overview.md)** (1 integrations)
  MaxMind provides geolocation and network intelligence data that maps IP addresses to geographic l...

**[Mnemonic Passive DNS](vendors/MnemonicPDNS/overview.md)** (2 integrations)
  Mnemonic Passive DNS provides historical DNS resolution data that helps analysts track domain inf...


### Phishing Intelligence

**[PhishTank](vendors/PhishTank/overview.md)** (1 integrations)
  Verify URL observables against community-reported phishing sites. Confirm if URLs in your cases a...
...
**[PAN Cortex XSOAR](vendors/CortexXSOAR/overview.md)** (1 integrations)
...
**[Google Threat Intelligence](vendors/GoogleThreatIntelligence/overview.md)** (5 integrations)
...
**[MalwareBazaar](vendors/MalwareBazaar/overview.md)** (1 integrations)
...
**[BackscatterIO](vendors/BackscatterIO/overview.md)** (2 integrations)
...
**[CheckPhish](vendors/CheckPhish/overview.md)** (2 integrations)

**[CheckPoint](vendors/CheckPoint/overview.md)** (2 integrations)

**[CIRCL Hash Lookup](vendors/CIRCLHashlookup/overview.md)** (1 integrations)

**[CIRCL Passive DNS](vendors/CIRCLPassiveDNS/overview.md)** (1 integrations)

**[CIRCL Passive SSL](vendors/CIRCLPassiveSSL/overview.md)** (1 integrations)
...
**[CyberCrime-Tracker](vendors/CyberCrime-Tracker/overview.md)** (1 integrations)

**[Cyberprotect](vendors/Cyberprotect/overview.md)** (1 integrations)
...
**[DNSdumpster](vendors/DNSdumpster/overview.md)** (1 integrations)

**[DNSLookingglass](vendors/DNSLookingglass/overview.md)** (1 integrations)
...
**[Gmail](vendors/Gmail/overview.md)** (5 integrations)

**[Google Safe Browsing](vendors/GoogleSafebrowsing/overview.md)** (1 integrations)
...
**[Jupyter](vendors/Jupyter/overview.md)** (2 integrations)

**[Kaspersky TIP](vendors/KasperskyTIP/overview.md)** (1 integrations)
...
**[MalwareClustering](vendors/MalwareClustering/overview.md)** (1 integrations)

**[Malwares](vendors/Malwares/overview.md)** (2 integrations)
...
**[MSRiskIQPassiveTotal](vendors/MSRiskIQPassiveTotal/overview.md)** (11 integrations)
...
**[PAN WildFire](vendors/PaloAltoWildFire/overview.md)** (2 integrations)
...
**[SentinelOne](vendors/SentinelOne/overview.md)** (4 integrations)
...
**[SpamAssassin](vendors/SpamAssassin/overview.md)** (1 integrations)

**[SpamhausDBL](vendors/SpamhausDBL/overview.md)** (1 integrations)
...
**[TorProject](vendors/TorProject/overview.md)** (1 integrations)

**[Triage](vendors/Triage/overview.md)** (1 integrations)

**[UnshortenLink](vendors/UnshortenLink/overview.md)** (1 integrations)

**[urlDNA.io](vendors/urlDNA.io/overview.md)** (2 integrations)
...
**[Cloudflare](vendors/Cloudflare/overview.md)** (1 integrations)
...
- **[Cisco Duo](vendors/CiscoDuo/overview.md)** - *Identity & Access Management* - 3 responders
- **[Cisco Secure Endpoint (Formerly AMP for Endpoints)](vendors/CiscoAMPforEndpoints/overview.md)** - *EDR* - 5 responders
...
- **[Palo Alto AutoFocus](vendors/PaloAltoAutofocus/overview.md)** - *Malware Analysis* - 3 analyzers
