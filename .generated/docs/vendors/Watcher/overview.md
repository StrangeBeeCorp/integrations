...
### [Watcher Check v1.0](https://github.com/TheHive-Project/Cortex-Analyzers/blob/master/analyzers/Watcher/Watcher_Check.json)
...
### [Watcher Transfer v1.1](https://github.com/TheHive-Project/Cortex-Analyzers/blob/master/responders/Watcher/Watcher_Transfer.json)
...
### [Watcher Remove v1.1](https://github.com/TheHive-Project/Cortex-Analyzers/blob/master/responders/Watcher/Watcher_Remove.json)
...
### [Watcher Update v1.1](https://github.com/TheHive-Project/Cortex-Analyzers/blob/master/responders/Watcher/Watcher_Update.json)
...
### [Watcher Add v1.1](https://github.com/TheHive-Project/Cortex-Analyzers/blob/master/responders/Watcher/Watcher_Add.json)
