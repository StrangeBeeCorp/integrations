/*---
thehive:
  name: computeTotalTimeSpent
  mode: Enabled
  definition: function_notifier_computeTotalTimeSpent
  description: On task closure, compute the duration of the task rounded up to the nearest minute. It's then added to the TASK_TIME_CUSTOMFIELD integer customfield at the case level. Use a trigger "task closed"
  type: Notifier
  vendor: Generic
  kind: function
  version: 1.0.0
